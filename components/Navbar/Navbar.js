...
const Navbar = () => {
	...
	return (
		<Box overflowX="hidden" w="100%" zIndex={99} pos="fixed">
			<Center w="100%" maxW="100%" bg="#22283C">
			...
			<Center w="100%" maxW="100%" bg={styles.background.light}>
				<Box w={styles.container.width} fontFamily="Montserrat">
					<Flex
						w="100%"
						h="90px"
			...
			>
				...
				<Menu id="Menu-inNavbar" preventOverflow strategy="fixed" offset={[20, 8]} isLazy>
					<MenuButton
						marginEnd="5"
						role="button"
						id="Menu-button-01"
