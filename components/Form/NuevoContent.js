	...
	<Center p="10" flexDirection="column">
		...
		<Flex flexDirection={["column", "column", "row", "row"]}>
			<Box p="10" w={["100%", "100%", "50%", "50%"]} flexDirection="column">
				<Text fontFamily={styles.font.fontFamily} textAlign="justify" color="#666666">
				...
				<Text fontFamily={styles.font.fontFamily} marginTop="8%" color="#666">
					Al hacer clic en “REGISTRARME”, reconoces haber leído las{" "}
					<Text
						fontFamily={styles.font.fontFamily}
						as="a"
						href="/politicas-de-privacidad.js"
						color="#0D47A1"
					>
						{" "}
